...
useRouteMatch is a React hook that allows you to find or have access to the object match, but you don't have to render <Route> to get access to the data.

1. How would you explain form validation to someone who has never programmed before?

Form validation ensures that the users correctly interact with the website (what is expected for each input, checkbox, etc.), otherwise it will notify users with error messages.

1. In 1-2 sentences, define end to end testing.

End to end testing is testing the website to verify that a user's entire experience is how the developer wants it to be. It replicates the experience of the the functionality and performance the user would have.
